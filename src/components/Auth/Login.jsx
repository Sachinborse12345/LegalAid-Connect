...
export default function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await login(form); // expects { accessToken, refreshToken, user } inside res.data
        ...
        <div className="relative rounded-2xl overflow-hidden shadow-2xl h-96 md:h-[520px]">
          ...
          <div className="relative z-10 p-8 h-full flex flex-col justify-end text-white">
            ...
            <p className="mt-3 max-w-md text-sm md:text-base text-white/90">
              Connect with lawyers and NGOs, get free legal guidance, and make
              your voice heard.
            </p>
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="bg-white/95 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-xl p-8 transform transition-all duration-300 hover:shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Sign in to access legal support and resources
                </p>
              </div>
            ...
            >
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition transform active:scale-[0.995] disabled:opacity-60"
                disabled={loading}
              >
